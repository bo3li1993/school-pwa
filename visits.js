...
export async function initVisitsModule() {
    ...
    container.innerHTML = `
        ...
        <style>
            .v-label{font-weight:700;font-size:14.5px;color:var(--text);display:block;margin-bottom:6px}
            .v-input{width:100%;padding:12px 14px;border:1.5px solid var(--line);border-radius:8px;font-family:'Cairo',sans-serif;font-size:16px;font-weight:600;text-align:right;outline:none}
            ...
            .crit-label{font-size:14px;font-weight:600;color:var(--text);flex:1}
            .crit-select{padding:8px 12px;border:1.5px solid var(--line);border-radius:7px;font-family:'Cairo',sans-serif;font-size:14px;font-weight:700;min-width:120px}
        </style>
    `;
